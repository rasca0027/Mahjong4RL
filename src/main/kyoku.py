...
class Kyoku:
    """A portion of the game, starting from the dealing of tiles and ends with
    the declaration of a win, aborted hand, or draw.
    """
    def __init__(self):
        self.winner = False
        # set four players
    ...
    # while self.winner == False, repeat Turn
