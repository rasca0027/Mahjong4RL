...
class TestTurnDrawFlow(unittest.TestCase):
    ...
    def test_draw_flow_suukaikan(self):
        ...
        kan = Huro(Naki.ANKAN, [Tile(Suit.SOUZU.value, 5),
    ...
    def test_draw_flow_suukantsu(self):
        for _ in range(3):
            self.tile_stack.add_dora_indicator()
        kan_1 = Huro(Naki.ANKAN, [Tile(Suit.SOUZU.value, 5)] * 4)
        kan_2 = Huro(Naki.ANKAN, [Tile(Suit.SOUZU.value, 6)] * 4)
        kan_3 = Huro(Naki.ANKAN, [Tile(Suit.SOUZU.value, 7)] * 4)
        kan_4 = Huro(Naki.ANKAN, [Tile(Suit.SOUZU.value, 7)] * 4)
    ...
    def test_suukantsu_other_player(self):
        for _ in range(4):
            self.tile_stack.add_dora_indicator()
        kan = Huro(Naki.DAMINKAN, [Tile(Suit.SOUZU.value, 5)] * 4)
        kabe = [kan]
        self.assertEqual(len(self.tile_stack.doras), 5)
    ...
    def test_no_suukaikan(self):
        self.tile_stack.add_dora_indicator()
        kan = Huro(Naki.ANKAN, [Tile(Suit.SOUZU.value, 5)] * 4)
        kabe = [kan]
        self.assertEqual(self.turn.check_suukaikan(kabe), False)
...
class TestTurnNakiFlow(unittest.TestCase):
    ...
    def test_suukantsu(self):
        for _ in range(3):
            self.tile_stack.add_dora_indicator()
        kan_1 = Huro(Naki.ANKAN, [Tile(Suit.SOUZU.value, 5),
                                  Tile(Suit.SOUZU.value, 5),
                                  Tile(Suit.SOUZU.value, 5),
                                  Tile(Suit.SOUZU.value, 5)])
        kan_2 = Huro(Naki.ANKAN, [Tile(Suit.SOUZU.value, 6),
                                  Tile(Suit.SOUZU.value, 6),
                                  Tile(Suit.SOUZU.value, 6),
                                  Tile(Suit.SOUZU.value, 6)])
        kan_3 = Huro(Naki.ANKAN, [Tile(Suit.SOUZU.value, 7),
                                  Tile(Suit.SOUZU.value, 7),
                                  Tile(Suit.SOUZU.value, 7),
                                  Tile(Suit.SOUZU.value, 7)])
        kan_4 = Huro(Naki.ANKAN, [Tile(Suit.SOUZU.value, 7),
                                  Tile(Suit.SOUZU.value, 7),
                                  Tile(Suit.SOUZU.value, 7),
                                  Tile(Suit.SOUZU.value, 7)])
        self.player_1.kabe.append(kan_1)
