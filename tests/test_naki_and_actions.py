...
class TestRon(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.player = Player('test', SeatWind.TON.value)
...
class TestTenpai(unittest.TestCase):
    ...
    def setUp(self):
        # tenpai: 3 MANZU 5 SOUZU
        self.player_1 = Player('test_1', SeatWind.TON.value)
        ...
        self.player_2 = Player('test_2', SeatWind.TON.value)
        ...
        self.player_3 = Player('test_3', SeatWind.TON.value)
        ...
        # tenpai: NAN 2 SOUZU
        self.player_4 = Player('test_4', SeatWind.TON.value)
        ...
        self.player_4.kabe.append(Huro(Naki.PON, [Tile(Suit.SOUZU.value, 5),
                                                  ...
                                                  Tile(Suit.SOUZU.value, 5)]))
        # tenpai: 2 MANZU
        self.player_5 = Player('test_5', SeatWind.TON.value)
        ...
        self.player_5.kabe.append(Huro(Naki.CHII, [Tile(Suit.MANZU.value, 7),
                                                   ...
                                                   Tile(Suit.MANZU.value, 9)]))
        # tenpai: TON
        self.player_6 = Player('test_6', SeatWind.TON.value)
        ...
        self.player_7 = Player('test_7', SeatWind.TON.value)
