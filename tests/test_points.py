...
class TestPoints(unittest.TestCase):
    ...
    def test_oya_tsumo(self):
        ...
        self.kyoku.apply_points(True, {self.player_1: (1, 30)})
    ...
    def test_oya_ron(self):
        self.kyoku.winners = [self.player_1]
        self.kyoku.apply_points(False, {self.player_1: (3, 70)}, self.player_2)
    ...
    def test_ko_tsumo(self):
        ...
        self.kyoku.apply_points(True, {self.player_2: (3, 30)})
    ...
    def test_ko_ron(self):
        self.kyoku.winners = [self.player_2]
        self.kyoku.apply_points(False, {self.player_2: (3, 30)}, self.player_4)
    ...
    def test_tsumo_with_honba(self):
        self.kyoku.winners = [self.player_2]
        self.kyoku.honba = 1
        self.kyoku.apply_points(True, {self.player_2: (4, 25)})
    ...
    def test_tsumo_with_kyotaku(self):
        ...
        self.kyoku.apply_points(True, {self.player_1: (6, 30)})
